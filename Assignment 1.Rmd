...
I have selected numeric variables to check the homogeniety. As per below the data belong together and there is no significant differences in the numeric data.
...
There are some high outliers are showing for some DHB but the total number  of DHB which are showing the outliers are less for a second dose compare to the fist dose. Extremely high outliers can be seen for the same DHB -  Auckland Metro DHB. 
...
There are some high outliers are showing for the age group from 12 to 44. Low and high outliers are showing for the age group 45-90+. Extremely high outlier is showing for the age group from 25 to 29. 
